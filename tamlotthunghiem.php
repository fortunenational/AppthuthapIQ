...
<?php
    ...
    if (isset($_GET['q']) && !empty($_GET['q'])) {
    	...
    	$sql = "SELECT * FROM tamlot WHERE id LIKE '%$keyword%' OR masptl LIKE '%$keyword%' OR mancc LIKE '%$keyword%' OR nhomsp LIKE '%$keyword%' OR tenspct LIKE '%$keyword%'";
    }else{
    	$sql = "SELECT * FROM tamlot";
    }
