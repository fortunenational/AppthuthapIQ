...
<?php
    ...
    if (isset($_GET['idhd'])) {
    	$keyIQ = $_GET['idhd'];
    	$sql_chitiet = "SELECT * FROM hopdong JOIN chitiethopdong ON hopdong.mahopdong=chitiethopdong.mahopdong WHERE chitiethopdong.mahopdong = '$keyIQ' ";
    }
...
<tr>
	<td><?php echo $row_chitiet['mahopdong'] ?></td>
	<td><?php echo $row_chitiet['nhomsp'] ?></td>
	<td><?php echo $row_chitiet['Doanhthu'] ?></td>
	<td><?php echo $row_chitiet['gianhapvevn'] ?></td>
	<td><?php echo $row_chitiet['loinhuangop'] ?></td>
