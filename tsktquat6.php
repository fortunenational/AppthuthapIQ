...
<?php
    ...
    if (isset($_GET['q']) && !empty($_GET['q'])) {
        ...
        $sql = "SELECT * FROM sanpham JOIN chitiettskt ON sanpham.masp = chitiettskt.masp WHERE nhomsp = 'Quạt' AND giatri = '1080000' ";
    }
...
<body> 
        ...
        <li><a href="hopdong.php">Hợp đông</a></li>
            ...
            <ul>
                <li><a href="tsktquat.php">Thông số kt quạt 1</a></li>
            </ul>
            <ul>
                <li><a href="tsktquat.php">Thông số kt quạt 1</a></li>
            </ul>            
