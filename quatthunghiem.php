...
<?php
    ...
    if (isset($_GET['q']) && !empty($_GET['q'])) {
    	...
    	$sql = "SELECT * FROM quat WHERE id LIKE '%$keyword%' OR maspquat LIKE '%$keyword%' OR mancc LIKE '%$keyword%' OR nhomsp LIKE '%$keyword%' OR tskt5 LIKE '%$keyword%'";
    }else{
    	$sql = "SELECT * FROM quat";
    }
